...
if __name__ == '__main__':
    ...
    # New Data
    gtex_data = pd.read_csv('ref/GTEx_Analysis_2017-06-05_v8_RSEMv1.3.0_transcript_expected_count.gct',sep='\t',skiprows=2)
    print('read')
    ...
    for tissue in tissues:
        ...
        # save tissue table
        gtex_data_tissue.to_csv('exp_cts/GTEx_{}_expected_counts_v8.tsv'.format(tissue),sep='\t')
